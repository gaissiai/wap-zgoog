        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tbody><tr>
                <td width="166" bgcolor="#f4f4f4" valign="top">
                    ...
                    <a href="<?php echo U('Category/index');?>" id="authority2" class="MenuSubButton">商品分类列表</a>
                    <a href="<?php echo U('Activity/index');?>" id="authority2" class="MenuSubButton">商品活动列表</a>
	...
	<table cellspacing="0" cellpadding="3" rules="cols" style="color:Black;background-color:White;border-color:#999999;border-width:1px;border-style:Solid;width:80%;border-collapse:collapse;border:1px solid #555">
		<tbody>
			...
			<?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr <?php echo ($k=='0'||$k%2=='') ?'style="background-color:#ddd"':''; ?>>
					<form method="post" enctype="multipart/form-data" action="<?php echo U('Index/Submit');?>">
					<input type="hidden" name='type'value="2">
					<input type="hidden" name='id' value="<?php echo ($vo["id"]); ?>">
					<td><?php echo ($vo["id"]); ?></td>
					<td width="340px">
						
						<img width="100px" style="float:left" class="file_but"  src="/Uploads/<?php echo ($vo["pic"]); ?>">
						<input style="float:left" type="file" name='file' class='file'>
					</td>

					<td><input type="text" name='text' value="<?php echo ($vo["text"]); ?>" style="width:90px"></td>
					...
					<td><input type="text" name="link_url" value="<?php echo ($vo["link_url"]); ?>"></td>
					<td align="center">
			...
			<tr class="add_div" style="opacity:0;">
				...
				<td><input type="text" name='text' value="" style="width:90px"></td>
